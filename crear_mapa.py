import matplotlib
matplotlib.use('Agg') # <-- LÍNEA CLAVE: Evita que se intente abrir una ventana
import pandas as pd
...
try:
    ...
    plt.title('Mapa de Posicionamiento Georeferencial')
    plt.xlabel('Longitud')
    plt.ylabel('Latitud')
    plt.grid(True)
    
    # Asegura que la escala de los ejes sea similar
